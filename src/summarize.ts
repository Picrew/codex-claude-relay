...
export function renderHandoff(input: RenderInput): HandoffContent {
  ...
  sections.push(
    `This handoff was synthesized by \`context-relay\` from the prior agent's native local transcript. ` +
  ...
  sections.push(`(Handoff generated by context-relay; source: ${sourceLine})`);
